...
def fileMaker(subfolder_path, fileName, routeText, feature):
    # Check and create the subfolder if it doesn't exist
    if not os.path.exists(subfolder_path):
        os.makedirs(subfolder_path)

    file_path = os.path.join(subfolder_path, fileName)
    routeText_path = os.path.join(subfolder_path, routeText)

    if os.path.exists(file_path):
        routeTime = os.path.getmtime(routeText_path)
